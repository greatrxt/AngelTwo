...
public class StatusService {
    ...
    @Path("/vehicle/{maxresults}")
    @Produces(MediaType.APPLICATION_JSON)
    @GET
    public Response getVehicleStatus(@PathParam("maxresults") int maxResults){
    	JSONObject vehicleStatus = new JSONObject();
    	JSONArray locationHistory = LocationDao.getLocationJson(maxResults);
